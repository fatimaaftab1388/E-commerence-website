    ...
    return(
        <div>
           <div className="login-container">
            ...
            <input type="text" onChange={handleInputs} name="FirstName" value={user.FirstName} ref={inputRef}/>
            <label style={{marginRight:'80%',paddingBottom:'2%',fontSize:'1.2em'}}>Last Name</label>
            <input type="text" onChange={handleInputs} name="LastName"value={user.LastName} />
                <label style={{marginRight:'88%',paddingBottom:'2%',fontSize:'1.2em'}}>E-mail</label>
            <input type="email" onChange={handleInputs} name="email"value={user.email} />
            <label style={{marginRight:'85%',paddingBottom:'2%',fontSize:'1.2em'}}>Password</label>
            <input type="password"  onChange={handleInputs} name="password" value={user.password}/>
            <button type="submit" style={{marginTop:'6%'}} onClick={e=>addDetails(e)}>Create</button>
